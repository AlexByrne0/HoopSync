...
require "templates/header.php"; // Include the header HTML
?>
...
<div class="comment-page-container">
    <div class="comment-form-section">
        ...
        <div class="center-image">
            <img src="images/lukatrade.png" alt="Lakers Trade Image">
        </div>
        ...
        // message after submitting comment
        <?php
    ...
    <div class="comment-list-section">
        ...
        try {
            ...
            $sql = "SELECT * FROM lakers_comments ORDER BY created_at DESC";
